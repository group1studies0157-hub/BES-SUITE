...
def extract_parameters(gad: GADText, api_key: str) -> ExtractedParams:
    """
    Call Claude API to extract structured parameters from GAD text.
    Returns an ExtractedParams object.
    """
    from gui.grs.core.api_client import make_client
